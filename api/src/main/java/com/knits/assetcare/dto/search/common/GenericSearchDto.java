package com.knits.assetcare.dto.search.common;
...
public abstract class GenericSearchDto<T>{
    ...
    protected abstract void addFiltersInternal(Root<T> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder, List<Predicate> filters);
